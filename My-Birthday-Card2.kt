        ...
        setContent {
            MyBirthdayCardTheme {
                ...
                Surface(
                    ...
                    BirthdayGreetingWithText(message ="Happiest Birthday Dad", from ="From:Klint")
                }
            }
        }
    }
...
fun BirthdayGreetingWithImagePreview() {
    MyBirthdayCardTheme {
        BirthdayGreetingWithImage(message ="Happiest Birthday Dad", from ="From: Klint")
    }
}
